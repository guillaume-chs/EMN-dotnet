...
{
    [Transaction(TransactionOption.Required), ObjectPooling(5, 10), EventTrackingEnabled(), Description("dal pour les hotels")]
    public class DALHotels: ServicedComponent
    {
